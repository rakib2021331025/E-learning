...
<div class="mx-5 mt-5 text-center">
  ...
  <?php 
    ...
    if (isset($_POST['delete']) && isset($_POST['id'])) {
        ...
        $sql = "DELETE FROM student WHERE stu_id = $del_id";
  ...
  ?>
    <table class="table" style="margin-left:100px;width:1400px;">
      <thead>
        <tr>
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
          <tr>
            ...
            <td>
              ...
              <!-- Edit Button -->
              <form method="POST" class="d-inline" action="editstudent.php">
                <input type="hidden" name="id" value="<?php echo $row['stu_id']; ?>">
