...
const adminEmail = $('input[name="sender"]').val();
const studentEmail = $('input[name="receiver"]').val();

function loadChat(){
    $.post("../chat/fetch_messages.php",{student_email:studentEmail}, function(data){
        $("#chatBox").html(data);
...
$("#clearChat").click(function(){
    if(confirm("Are you sure to clear all chats?")){
        $.post("../chat/clear_chat.php",{u1:adminEmail,u2:studentEmail}, function(){ loadChat(); });
    }
});
...
$('#recStop').click(function(){
    ...
    mediaRecorder.onstop = ()=>{
        ...
        fd.append('sender',adminEmail);
        fd.append('receiver',studentEmail);
        fd.append('file',file);
